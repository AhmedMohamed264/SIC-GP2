...
// WiFi credentials
const char* ssid = "omar2002";          // Replace with your WiFi SSID
const char* password = "12345678";  // Replace with your WiFi Password

// MQTT broker credentials
const char* mqttServer = "bfd52fa5a5db428a87c9ee343269e1d9.s1.eu.hivemq.cloud";
...
void loop() {
  ...
  // Call the client loop function regularly
  client.loop();
}
